...
void test_add_polar_entries_to_menu(void) {
    ...
    struct test_field test_cases[] = {
        ...
        {{1, 0, 0}, "090.0`", "+0.0`", "Dist  1.00", "Ext  1.00"},
        {{0, 1, 0}, "000.0`", "+0.0`", "Dist  1.00", "Ext  1.00"},
        {{3, 0, 4}, "090.0`", "+53.1`","Dist  5.00", "Ext  3.00"},
        {{0, -3, 4}, "180.0`", "+53.1`","Dist  5.00", "Ext  3.00"},
        {{0.3, 0.4, 0.0}, "036.9`", "+0.0`", "Dist  0.50", "Ext  0.50"},
        {{0.3, -0.4, 1.2}, "143.1`", "+67.4`", "Dist  1.30", "Ext  0.50"}
    };
    int i, j;
    gsl_vector_view orientation;
    for (i=0; i<7; i++) {
