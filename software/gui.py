...
# -*- coding: UTF-8 -*-3
#
# generated by wxGlade 0.8.0 on Sun Feb 10 17:11:26 2019
#
...
class PonyFrame(wx.lib.docview.DocMDIParentFrame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: PonyFrame.__init__
        kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_FRAME_STYLE
        wx.lib.docview.DocMDIParentFrame.__init__(self, *args, **kwds)
    ...
    def SetPreferences(self, event):  # wxGlade: PonyFrame.<event_handler>
    ...
    def SaveAs(self, event):  # wxGlade: PonyFrame.<event_handler>
        print("Event handler 'SaveAs' not implemented!")
        event.Skip()

    def Cut(self, event):  # wxGlade: PonyFrame.<event_handler>
        print("Event handler 'Cut' not implemented!")
        event.Skip()

    def Copy(self, event):  # wxGlade: PonyFrame.<event_handler>
        print("Event handler 'Copy' not implemented!")
        event.Skip()

    def Paste(self, event):  # wxGlade: PonyFrame.<event_handler>
...
class AboutDialog(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        label_2 = wx.StaticText(self, wx.ID_ANY, "\u00a9 2019 Phil Underwood", style=wx.ALIGN_CENTER)
