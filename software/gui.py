...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.8.0 on Fri Jan 25 22:13:01 2019
#
...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Tool Bar end
        self.text = wx.stc.StyledTextCtrl(self, wx.ID_ANY)
...
class ImportDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_DIALOG_STYLE
        wx.Dialog.__init__(self, *args, **kwds)
        self.survey_list = wx.ListCtrl(self, wx.ID_ANY, style=wx.LC_AUTOARRANGE | wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
