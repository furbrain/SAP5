...
ErrorStatus PKA_SetData(uint8_t dataType, uint32_t* srcData) {
	const uint8_t P256_P_LE[32] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
			0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xff,
			0xff, 0xff, 0xff };
	const uint8_t BLE_P256_ABELIAN_ORDER_R_LE[32] = { 0x51, 0x25, 0x63, 0xFC,
			0xC2, 0xCA, 0xB9, 0xF3, 0x84, 0x9E, 0x17, 0xA7, 0xAD, 0xFA, 0xE6,
			0xBC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00,
	...
	if (dataType == PKA_DATA_SK) {
		if (rev_memcmp((uint8_t *) srcData,
				(uint8_t *) BLE_P256_ABELIAN_ORDER_R_LE, 32) >= 0) {
