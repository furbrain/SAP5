 ...
 */
__STATIC_INLINE uint32_t TIMER_GetCurrentMachineTime(void) {
	return BLUE_CTRL->CURRENT_TIME;
}
 ...
 */
__STATIC_INLINE uint32_t TIMER_GetHostTimeoutReg(void) {
	return BLUE_CTRL->HOST_WKUP_TIMER;
}

/**
 * @brief  Get radio controller timer timeout.
 */
__STATIC_INLINE uint32_t TIMER_GetTimeoutReg(void) {
	return BLUE_CTRL->TIMEOUT;
}

/**
 * @brief  Set radio controller timer timeout.
 */
__STATIC_INLINE void TIMER_SetTimeoutReg(uint32_t value) {
	BLUE_CTRL->TIMEOUT = value;
}

/**
 * @brief  Enable BlueIRQ.
 */
__STATIC_INLINE void TIMER_EnableBlueIRQ(void) {
	NVIC_EnableIRQ(BLUE_CTRL_IRQn);
}

/**
 * @brief  Disable BlueIRQ.
 */
__STATIC_INLINE void TIMER_DisableBlueIRQ(void) {
	NVIC_DisableIRQ(BLUE_CTRL_IRQn);
}
