 ...
 * @retval Value indicating success or error code.
 */
tBleStatus hci_read_rssi(uint16_t Connection_Handle, int8_t *RSSI);
/**
...
tBleStatus hci_le_set_advertising_parameters(uint16_t Advertising_Interval_Min,
		...
		uint8_t Peer_Address[6], uint8_t Advertising_Channel_Map,
 ...
 * @retval Value indicating success or error code.
 */
tBleStatus hci_le_encrypt(uint8_t Key[16], uint8_t Plaintext_Data[16],
...
tBleStatus hci_le_start_encryption(uint16_t Connection_Handle,
		uint8_t Random_Number[8], uint16_t Encrypted_Diversifier,
...
tBleStatus hci_le_add_device_to_resolving_list(
		uint8_t Peer_Identity_Address_Type, uint8_t Peer_Identity_Address[6],
		uint8_t Peer_IRK[16], uint8_t Local_IRK[16]);
/**
...
tBleStatus hci_tx_acl_data(uint16_t Connection_Handle, uint8_t PB_Flag,
		uint8_t BC_Flag, uint16_t Data_Length, uint8_t* PDU_Data);
/**
 * @}
 */
/**
...
tBleStatus aci_gap_set_limited_discoverable(uint8_t Advertising_Type,
		...
		uint8_t Service_Uuid_length, uint8_t Service_Uuid_List[],
...
tBleStatus aci_gap_set_direct_connectable(uint8_t Own_Address_Type,
		...
		uint8_t Direct_Address[6], uint16_t Advertising_Interval_Min,
 ...
 * @retval Value indicating success or error code.
 */
tBleStatus aci_gap_update_adv_data(uint8_t AdvDataLen, uint8_t AdvData[]);
/**
...
tBleStatus aci_gap_start_name_discovery_proc(uint16_t LE_Scan_Interval,
		...
		uint8_t Peer_Address[6], uint8_t Own_Address_Type,
		uint16_t Conn_Interval_Min, uint16_t Conn_Interval_Max,
		uint16_t Conn_Latency, uint16_t Supervision_Timeout,
		uint16_t Minimum_CE_Length, uint16_t Maximum_CE_Length);
/**
...
tBleStatus aci_gap_start_selective_connection_establish_proc(
		...
		uint8_t Num_of_Whitelist_Entries, Whitelist_Entry_t Whitelist_Entry[]);
/**
...
tBleStatus aci_gap_set_broadcast_mode(uint16_t Advertising_Interval_Min,
		uint16_t Advertising_Interval_Max, uint8_t Advertising_Type,
		uint8_t Own_Address_Type, uint8_t Adv_Data_Length, uint8_t Adv_Data[],
		uint8_t Num_of_Whitelist_Entries, Whitelist_Entry_t Whitelist_Entry[]);
/**
...
tBleStatus aci_gap_get_oob_data(uint8_t OOB_Data_Type, uint8_t *Address_Type,
		uint8_t Address[6], uint8_t *OOB_Data_Len, uint8_t OOB_Data[16]);
/**
...
tBleStatus aci_gap_set_oob_data(uint8_t Device_Type, uint8_t Address_Type,
		uint8_t Address[6], uint8_t OOB_Data_Type, uint8_t OOB_Data_Len,
		uint8_t OOB_Data[16]);
/**
...
tBleStatus aci_gatt_add_service(uint8_t Service_UUID_Type,
		Service_UUID_t *Service_UUID, uint8_t Service_Type,
...
tBleStatus aci_gatt_include_service(uint16_t Service_Handle,
		...
		uint8_t Include_UUID_Type, Include_UUID_t *Include_UUID,
...
tBleStatus aci_gatt_add_char(uint16_t Service_Handle, uint8_t Char_UUID_Type,
		Char_UUID_t *Char_UUID, uint16_t Char_Value_Length,
...
tBleStatus aci_gatt_add_char_desc(uint16_t Service_Handle, uint16_t Char_Handle,
		uint8_t Char_Desc_Uuid_Type, Char_Desc_Uuid_t *Char_Desc_Uuid,
		uint8_t Char_Desc_Value_Max_Len, uint8_t Char_Desc_Value_Length,
		uint8_t Char_Desc_Value[], uint8_t Security_Permissions,
...
tBleStatus aci_att_find_by_type_value_req(uint16_t Connection_Handle,
		...
		uint8_t Attribute_Val_Length, uint8_t Attribute_Val[]);
/**
...
tBleStatus aci_gatt_read_multiple_char_value(uint16_t Connection_Handle,
		uint8_t Number_of_Handles, Handle_Entry_t Handle_Entry[]);
/**
...
tBleStatus aci_gatt_set_desc_value(uint16_t Serv_Handle, uint16_t Char_Handle,
		...
		uint8_t Char_Desc_Value_Length, uint8_t Char_Desc_Value[]);
/**
